...
`@enqoding/node-red-contrib-quantum` provides Node-RED nodes that let security orchestration flows build quantum circuits, execute quantum-inspired algorithms, and exchange results with classical workflow steps.
